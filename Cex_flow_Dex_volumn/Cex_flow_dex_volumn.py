...
def get_cex_flow(chain_id, contract_id, time_from):
    ...
    for key, value in time_dict.items():
        new = {'time': key, 'in_amount': format_number(value['in_amount']), 'out_amount': format_number(value['out_amount'])}
        cex_flow.append(new)
    
    return cex_flow

def get_dex_volumn(chain_id, contract_id, time_from):
    if chain_id not in chain_list:
        print(f"Error: {chain_id} not in supported chain list")
        print("Supported chain list:", end = "")
        print(chain_list)
    ...
    for key, value in sum_dict.items():
        new = {'time': key, 'volumn': format_number(value)}
...
data_cex = get_cex_flow('ethereum','0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE', 1680307200)

data_dex = get_dex_volumn('ethereum','0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE', 1680307200)

#print(data_cex[0])

print('Cex flow of token SHIB on etherum from 2023-03-31:')

for item in data_cex:
   print(item)
   
print('Dex volumn of token SHIB on etherum from 2023-03-31:')
